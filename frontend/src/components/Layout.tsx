        ...
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <header style={{
                ...
                <a href="/"><Dumbbell size={32} color="var(--danger) " />
                    <span style={{ fontWeight: 700, fontSize: '1.25rem', color: 'var(--primary)', marginLeft: '7px' }}>Fitness Tracker</span></a>
            ...
            <div style={{ display: 'flex', flex: 1 }}>
                ...
                <aside style={{
                    ...
                    <div style={{ marginBottom: '2rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        <a href="/"><Dumbbell size={26} color="var(--danger) " />
                            <span style={{ fontWeight: 800, fontSize: '1.4rem', color: 'var(--danger)', marginLeft: '8px' }}>Fitness Tracker</span></a>
                    </div>
